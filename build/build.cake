...
var paths = new {
    src = MakeAbsolute(Directory("./..")).FullPath,
    solution = MakeAbsolute(File("./../StringFormatter.sln")).FullPath,
    props = MakeAbsolute(File("./../Directory.Build.props")).FullPath,
...
Task("Nuget")
    ...
    .Does(() => {
        ...
        Information("       git tag v{0}", XmlPeek(paths.props, @"/Project/PropertyGroup/StringFormatterVersion/text()"));
